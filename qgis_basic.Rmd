...
<div class = "blue">
In this short tutorial I am scripting a  workflow for working with LiDAR data downloaded from  [Scottish Remote Sensing Portal](https://remotesensingdata.gov.scot/). The aim is to process the raw LAZ files, produce  visualizations and take simple measurments solely relaying on R programming language. 
...
print(las)
plot(readLASheader("data/NX6055_4PPM_LAS_PHASE3.laz"))
...
<p style="text-align: center;"><span style="color: #808080;"><em>michal.michalski@scot.gov</em></span></p>
